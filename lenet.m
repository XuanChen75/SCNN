...
%load scnn.mat wconv1 wconv2 wfc1 wfc2 wfc3
%load scnn.mat bconv1 bconv2 bfc1 bfc2 bfc3
...
for n=1:1:60000
    ...
    for ii=1:1:28
        for jj=1:1:28
            value_conv1(ii,jj,:)=bconv1;
        end
    end
    
    for ii=1:1:10
        for jj=1:1:10
            value_conv2(ii,jj,:)=bconv2;
        end
    end
    ...
    for kk=1:1:6
        for ii=1:1:28
            for jj=1:1:28
                for xx=1:1:5
                    for yy=1:1:5
                        value_conv1(ii,jj,kk)=value_conv1(ii,jj,kk)+data(ii+xx-1,jj+yy-1,n) * wconv1(xx,yy,1,kk);
                    end
                end
...
%save test_0bias.mat test_0bias
%save test_lenetbn.mat test_lenetbn
...
save lumda_lenetbn.mat lumda_conv1 lumda_conv2 lumda_fc1 lumda_fc2 lumda_fc3
